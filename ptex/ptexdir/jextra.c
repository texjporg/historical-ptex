/*
 * jextra.c : Hand-coded routines for Japanes C TeX.
 */
...
short		f;
{
	...
	register memoryword	*bp, *sp, *ep, *mp;
...
#else /* not BUGCOMPATIBLE */
quarterword getjfmpos(kcode, f) /* getjfmpos simpler version */
KANJIcode kcode;
short f;
{
	register unsigned short jc;
