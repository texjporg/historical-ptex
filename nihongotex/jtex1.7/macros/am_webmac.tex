...
\xdef\fmtversion{\fmtversion+WEBMAC1.3}
\parskip 0pt % no stretch between paragraphs
\parindent 1em % for paragraphs and for the first line of Pascal text

\font\eightrm=amr8 % this will eventually become cmr8
\let\sc=\eightrm \let\mainfont=\tenrm
\font\titlefont=amr7 scaled\magstep4 % title on the contents page
\font\ttitlefont=amtt10 scaled\magstep2 % typewriter type in title
\font\tentex=amtex10 % TeX extended character set (used in strings)
