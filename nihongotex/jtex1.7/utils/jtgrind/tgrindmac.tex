...
\font\sevenrm=amr7			% font for right margin line numbers
\font\twelvebf=ambx10 scaled \magstep1	% font for page headers
\font\forteenrm=amr10 scaled \magstep2	% font for right margin proc names
...
\def\space{\ifstring\char'040 \else \hskip 1\ts\relax \fi}
