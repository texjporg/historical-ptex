 ...
 */
/*
 * amble.h - Preamble & Postamble dimension size.
 */

/*
 * $Id: amble.h,v 1.4 90/03/27 10:51:24 void Exp $
 */

typedef struct {
    Sig4Byte    Num;		/* Numerator */
    Sig4Byte    Den;		/* Denominator */
    Sig4Byte    Mag;		/* Magnification */
} DIMENSION;
