...
% LaTeX: File called JLPLAIN
% Identify the current format
\def\fmtname{jlplain}
\def\fmtversion{2.09J-11/18/89} % identifies the current format
...
\def\@arrayclassz{\ifcase \@lastchclass \@acolampacol
   \or \@ampacol \or \or \or \@addamp \or
   \@acolampacol \or \@firstampfalse \@acol \fi
\edef\@preamble{\@preamble
  \ifcase \@chnum 
     \hfil$\relax\noexpand\<\@sharp$\hfil \or $\relax\noexpand\<\@sharp$\hfil 
    \or \hfil$\relax\noexpand\<\@sharp$\fi}}

\def\@tabclassz{\ifcase \@lastchclass \@acolampacol \or
   \@ampacol \or \or \or \@addamp \or
   \@acolampacol \or \@firstampfalse \@acol \fi
\edef\@preamble{\@preamble
  \ifcase \@chnum 
     \hfil\ignorespaces\noexpand\<\@sharp\unskip\hfil 
     \or \ignorespaces\noexpand\<\@sharp\unskip\hfil 
     \or \hfil\hskip\z@ \ignorespaces\noexpand\<\@sharp\unskip\fi}}
