% File LFONTS - Version of 12 December 1989.
%
...
\def\@@readf#1#2{\@ifundefined{\string#1}{\global\font#1#2\relax}{}}
\def\@readfont#1#2#3#4#5#6#7{\@@readf#1{#2}\@@readf#3{#4}\@@readf#5{#6}%
\@setfam#1#3#5#7\fam#7#1}
\def\@setfam#1#2#3#4{\textfont#4#1\scriptfont#4#2\scriptscriptfont#4#3}
...
\newfam\mcfam      % \mc is family 11
\newfam\gtfam      % \gt is family 12
\newfam\chfam	   % MFchel family 13
...
\def\pel{\@@readf\@el@{mcelite}\@el@}
\def\pbel{\@@readf\@bel@{mcbelit}\@bel@}
\def\ppi{\@@readf\@pi@{mcpica}\@pi@}
\def\pbpi{\@@readf\@bpi@{mcbpica}\@bpi@}
