...
#define paramsize 60 
#define nestsize 40 
#define maxstrings 6600 
#define stringvacancies 25000 
#define poolsize 75000L 
#define savesize 4000 
#define triesize 8000 
#define dvibufsize 16384 
#define filenamesize 1024 
#define poolname "jtex.pool" 
#define memtop 327670L 
...
typedef struct {
    short modefield ; 
  halfword headfield, tailfield, lastjchrfield ; 
...
EXTERN memoryword zeqtb[13508]  ; 
EXTERN quarterword 
#define xeqlevel (zzzad -12284)
  zzzad[712]  ; 
EXTERN twohalves 
...
EXTERN boolean fontjtype[fontmax + 1]  ; 
